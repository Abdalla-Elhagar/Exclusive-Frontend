...
export default function Header() {
  return (
    <header>
      <Typography
        component="div"
        className="min-w-full max-md:flex-col flex max-sm:flex-row max-lg:justify-between px-5 items-center text-[#FAFAFA] relative text-end text-[14px] min-h-[48px] bg-black"
      >
